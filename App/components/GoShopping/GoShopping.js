  ...
  Card(x){
    return (
      <View style={styles.card}>
        ...
        <View style={{padding:13,  borderLeftWidth:1,borderColor:'#e3e3e3', alignItems:'center', justifyContent:'space-between'}}><Image source = {require('../images/suit.png')} name='people-outline' size={20} color="#777" style={{width:25, height:25, margin:10}} /><Text style={{fontSize:16, fontWeight:'200', color:'#555'}}>{x.friends}</Text></View>
        <View style={{padding:13, borderLeftWidth:1,borderColor:'#e3e3e3', alignItems:'center', justifyContent:'space-between'}}><Image source = {require('../images/suit.png')} name='import-contacts' size={20} color="#777" style={{width:25, height:25, margin:10}} /><Text style={{fontSize:16, fontWeight:'200', color:'#555'}}>{x.interests}</Text></View>
        </View>
        </View>
      </View>
    )
